...
filename     = "zener_part_c_readings"              #filename : This is name of the file containing the x and y values
Plot_Title   =  "Vout vs RL"
x_axis_label = "RL (ohms)"
y_axis_label = "Vout (Volts)"
