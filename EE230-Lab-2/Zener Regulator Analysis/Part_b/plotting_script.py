...
filename     = "zener_part_b_curr"              #filename : This is name of the file containing the x and y values
Plot_Title   =  "Vin vs Currents"
x_axis_label = "Vin (Volts)"
y_axis_label = "Current (A)"
number_of_curves_in_plot = 3
legend_list = ["I_L", "I_S", "I_Z"]
